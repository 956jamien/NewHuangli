...
# 每日胎神
fetalGodList = ('碓磨门外东南', '碓磨厕外东南', '厨灶炉外正南', '仓库门外正南', '房床厕外正南', '占门床外正南', '占碓磨外正南', '厨灶厕外西南', '仓库炉外西南', '房床门外西南', '门碓栖外西南', '碓磨床外西南',
...
thingsSort = (
    '诸事不宜', '诸事不忌', '馀事勿取', '无',
    '祈福', '祭祀', '齐醮', '斋醮', '沐浴', '酬神', '焚香', '普渡', '祀灶',
    '结婚', '结婚姻', '嫁娶', '订婚', '纳采', '纳采问名', '问名', '纳婿', '归宁', '合帐', '合账', '合帳',
    '搬家', '移徙', '入宅', '搬移',
    '开业', '开市', '开张', '挂匾', '纳财', '求财', '开仓', '开仓库', '出货财',
    '签约', '交易', '立券', '立券交易', '订盟', '雇佣',
    '出行', '乘船渡水', '乘船', '渡水',
    '开工', '修造', '拆卸', '破屋', '坏垣', '补垣', '修门', '修饰垣墙', '作梁', '造仓', '造仓库', '破屋坏垣',
    '开井开池', '掘井', '开池', '开渠', '开渠穿井', '放水', '作陂放水', '筑堤', '筑堤防', '造桥', '塞穴', '平治道涂',
    '安机械', '安机', '造车器', '鼓铸', '造船', '作染', '安碓硙', '造畜稠', '伐木', '伐木(做梁)', '穿屏扇架', '开柱眼', '架马', '酝酿', '雕刻',
    '打扫', '扫舍宇', '扫舍', '断蚁',
    '理发', '剃头', '整手足甲',
    '求医', '治病', '求医疗病',
    '理疗', '针灸', '经络',
    ...
    '买车',
    '固定资产', '置产',
    '宴会', '安床', '上表章', '上官', '入学', '冠带', '进人口',
    '裁衣', '竖柱上梁', '修置产室',
    '捕捉', '畋猎', '栽种', '牧养', '破土', '安葬', '启攒'
)

THING_CATEGORY_BASE = (
    '结婚', '搬家', '开业', '签约', '出行', '开工', '打扫', '理发', '祈福', '买车', '固定资产',
    '求医', '理疗', '请客会友', '医美'
)

THING_CATEGORY_MAP = {
    **{name: name for name in THING_CATEGORY_BASE},
    '嫁娶': '结婚',
    '结婚姻': '结婚',
    '订婚': '结婚',
    '纳采': '结婚',
...
THING_NORMALIZE_EXCLUDE = {'诸事不宜', '诸事不忌', '馀事勿取', '无'}
